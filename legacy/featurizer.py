...
class Featurizer(object):
    ...
    def __init__(self, train=None, model=None, extrachem=None, bert_pretrain_path='dmis-lab/biobert-base-cased-v1.2'):#dmis-lab/biobert-base-cased-v1.2
        """
    ...
    def _load_dicts(self):
        ...
        f = open("EnzymeNames.txt", "r", encoding="utf-8", errors="replace") #####################################
        self.tokenizer = AutoTokenizer.from_pretrained('dmis-lab/biobert-base-cased-v1.2')#'allenai/scibert_scivocab_cased'self.bert_pretrain_path)"dmis-lab/biobert-base-cased-v1.2"
        for l in f:
            l = l.strip()
            if len(l) > 0:
